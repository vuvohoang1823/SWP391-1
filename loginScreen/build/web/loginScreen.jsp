        ...
        <div class="row login-box">
            ...
            <div class="col-lg-6 auth-side">
                ...
                <form class="form-control" action="">
                    <input class="email" type="text" placeholder="Phone number or email" required>
                    <input class="password" type="password" placeholder="Password" required>
                    <button class="login-btn" value="">Login</button>
                    <a href="#">Forgot password?</a>
                    <div class="line"></div>
                </form>
                <button class="cna-btn" value=""><a href="#">Create new account</a></button>
            </div>
        </div>
    </div>
